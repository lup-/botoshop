            ...
            <v-expansion-panels>
                <v-expansion-panel>
                    ...
                    <v-expansion-panel-content>
                        <p class="">Просмотр сохраняется перед отправкой сообщения с текстом этапа.</p>
                        <p class="mb-0">Пользователь нажал на кнопку и перешел к этапу. Просмотр фиксируется при отправке сообщения после нажатия кнопки.</p>
                        <p class="mb-0">Сработал таймер перехода. Просмотр фиксируется при отправке сообщения по таймеру.</p>
                        <p class="mb-0">Произошел сбой и этап был отправлен дважды. Будет записано два просмотра.</p>
                        <p class="mb-0">Уникальные просмотры записаны в столбце "Пользователи".</p>
                    </v-expansion-panel-content>
                    <v-expansion-panel-content>
                        <v-form>
                            <v-row>
